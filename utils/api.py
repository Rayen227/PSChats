...
def _record(if_cmu: bool = False):
    ...
    # file_name = path.join(path.dirname(path.abspath(__file__)), "cache/cache01.wav")
    file_name = 'D:\GitBase\PSChats\cache\cache01.wav'
...
def speech_to_text_baidu(audio_path: str = "cache02.wav", if_microphone: bool = True):
    ...
    secret_key = "kGseRmBZnW88UvMq7tboA5Naf4ylRb8G"
